    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-5 bg-white border border-neutral-200 rounded-xl shadow-xs">
          ...
          <p className="text-2xl font-bold text-neutral-900 mt-2">12</p>
        ...
        <div className="p-5 bg-white border border-neutral-200 rounded-xl shadow-xs">
          ...
          <p className="text-2xl font-bold text-neutral-900 mt-2">$14,190</p>
          <span className="text-xs font-medium text-neutral-500 mt-1 inline-block">
            out of $22,500 total
          </span>
        </div>
        ...
        <div className="p-5 bg-white border border-neutral-200 rounded-xl shadow-xs">
          ...
          <p className="text-2xl font-bold text-neutral-900 mt-2">6,260</p>
          <span className="text-xs font-medium text-emerald-600 mt-1 inline-block">
            +14% vs last month
          </span>
        </div>
        ...
        <div className="p-5 bg-white border border-neutral-200 rounded-xl shadow-xs">
          ...
          <p className="text-2xl font-bold text-neutral-900 mt-2">4.18%</p>
          <span className="text-xs font-medium text-emerald-600 mt-1 inline-block">
            +0.5% this week
          </span>
        </div>
            ...
            <tbody className="divide-y divide-neutral-200">
              {MOCK_CAMPAIGNS.map((campaign) => (
                <tr key={campaign.id} className="hover:bg-neutral-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    {campaign.spent} / <span className="text-neutral-400">{campaign.budget}</span>
                  </td>
